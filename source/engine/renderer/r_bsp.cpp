...
//
//=============================================
FORCE_INLINE void CBSPRenderer::BatchSurface( msurface_t* psurface )
{
...
//
//=============================================
FORCE_INLINE void CBSPRenderer::AddBatch( CArray<drawbatch_t>& batches, Uint32& numbatches, bsp_surface_t *psurface )
{
	drawbatch_t *pbatch;
	if(numbatches > 0)
	{
